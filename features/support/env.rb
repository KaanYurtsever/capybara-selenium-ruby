...
Capybara.configure do |config|
  config.app_host = ConfigReader.prod_url
  config.default_selector = :xpath
  config.default_max_wait_time = ConfigReader.wait_time
...
AllureCucumber.configure do |config|
  config.results_directory = 'output/allure-results'  #fail results go to this dir
